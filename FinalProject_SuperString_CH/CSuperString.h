...
public:
	...
	//Boolean Operators
	bool operator == (const char* pstrStringToCompare);
	bool operator == (const char chrLetterToCompare);
	bool operator == (const CSuperString& ssStringToCompare);
	...
	//Comparison Operators (I guess these are technically boolean too but bleh.)
	bool operator < (const char* pstrStringToCompare);
	bool operator < (const char chrLetterToCompare);
	bool operator < (const CSuperString& ssStringToCompare);
